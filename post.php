...
<body class="body">    
    <header class="header">
        <div class="container header_content">
            <a class="header_logo" href="##">Escape.</a>
            <nav class="navigation">
                <ul class="navigation_list">
                    <li class="navigation_list-item"><a class="link navigation_link" href="##">HOME</a></li>
    ...
    <main>       
        ...
        <img class="main_image" src="/static/images/northern-lights.png" alt="Северное сияние">
        <div class="main_text">
    ...
    <footer class="footer">
        <div class="container footer_content">
            <a class="footer_logo" href="##">Escape.</a>
            <nav class="navigation">
                <ul class="navigation_list">
                    <li class="navigation_list-item"><a class="navigation_link navigation__link_light" href="##">HOME</a></li>
